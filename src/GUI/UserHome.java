...
public class UserHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        makereservation1.setText("Make Reservation");

        details2.setText("Details");

        makereservation2.setText("Make Reservation");

        details3.setText("Details");

        makereservation3.setText("Make Reservation");

        details4.setText("Details");

        makereservation4.setText("Make Reservation");

        details5.setText("Details");

        makereservation5.setText("Make Reservation");
